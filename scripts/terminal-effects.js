/**
 * Delta Green Terminal Style - Effects and advanced configuration
 */

class CyberpunkTerminalEffects {
    static MODULE_ID = 'delta-green-terminal-style';
    static MODULE_TITLE = 'Delta Green Terminal Style';
